...
// ===========================================================================
{
  const fs = require('fs');
  const corpusPath =
    'test-fixtures/adv-org/force-app/main/default/classes/AcmePropertyConsumer.cls';
...
// ===========================================================================
{
  ...
  const forceAppRoot = 'test-fixtures/adv-org/force-app';
...
// ===========================================================================
{
  ...
  const classesDir = path.join(forceAppRoot, 'main/default/classes');
  const triggersDir = path.join(forceAppRoot, 'main/default/triggers');
  const scriptsDir = 'test-fixtures/adv-org/scripts';
...
// ===========================================================================
{
  const fs = require('fs');
  const path = require('path');
  const classesDir = 'test-fixtures/gauntlet-org/force-app/main/default/classes';
  const parseCorpusFile = (p) => parseFile({ path: p, text: fs.readFileSync(p, 'utf8') });
